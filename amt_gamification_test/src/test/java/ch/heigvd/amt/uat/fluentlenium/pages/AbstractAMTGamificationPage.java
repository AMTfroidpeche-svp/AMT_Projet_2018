 ...
 * @author Olivier Kopp
 */
public abstract class AbstractAMTGamificationPage extends FluentPage {
   ...
   */
  private final static String menu = "#nav";
  private final static String profileLink = "#profileNav"; // this is the HTML id of the menu
  private final static String appLink = "#appNav";
  private final static String createAppLink = "#createAppNav";
  private final static String logoutLink = "#logoutNav";
   ...
   */
  public void goToProfilePageViaMenu() {
    click(menu);
    click(profileLink);
  }

  public void goToAppPageViaMenu() {
    click(menu);
    click(appLink);
  }

  public void goToCreateAppPageViaMenu() {
    click(menu);
    click(createAppLink);
  }
