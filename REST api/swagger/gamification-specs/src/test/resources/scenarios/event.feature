Feature: full scenario testing different rule option
  ...
  Scenario: full scenario
    ...
    When I GET to the /users endpoint the app app1 and the user user1
    Then The user user1 should have correct badges : badge1 and correct pointScales : pointScale1;pointScale2 with correct ammount of points : 30;0
    ...
    When I GET to the /users endpoint the app app1 and the user user1
    Then The user user1 should have correct badges : badge1;badge2 and correct pointScales : pointScale1;pointScale2 with correct ammount of points : 70;20
