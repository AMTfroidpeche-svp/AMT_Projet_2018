...
public class DeleteSteps {
    ...
    public void i_want_to_delete_a_badge(String badgeName, String appName) throws Throwable {
        badge = new Badge();
    ...
    public void i_want_to_delete_a_PointScale(String pointScaleName, String appName) throws Throwable {
    ...
    public void i_want_to_delete_a_rule(String ruleName, String appName) throws Throwable {
    ...
    public void i_DELETE_it_to_an_endpoint(String endPoint) throws Throwable {
        try {
            switch (endPoint) {
                case "badges":
